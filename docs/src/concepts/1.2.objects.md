...
`obj` contains "objective" information about something — information that sets by scripts and that should not be changed, for example, original name, declared date of creation, source. 
